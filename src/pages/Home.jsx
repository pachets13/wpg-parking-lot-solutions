...
// ── BenefitRow ──────────────────────────────────────────────────────
function BenefitRow({ icon, title, body, 'data-fade': dataFade, style }) {
  return (
    <div className="benefit-row" {...(dataFade !== undefined ? { 'data-fade': true } : {})} style={style}>
...
export default function Home() {
  ...
  return (
    <>
      <SEO
        title="Winnipeg Commercial Parking Lot Experts Since 1996"
        description="WPG Parking Lot Solutions — year-round commercial parking lot maintenance in Winnipeg. Asphalt, concrete, snow & ice management, and design-build services."
        path="/"
      />
      ...
      <section className="hero hero--full">
        ...
        <div
          className="hero__bg"
          style={{
            backgroundImage: `url(${import.meta.env.BASE_URL}assets/images/hero/hero-home.jpg)`,
          }}
          aria-hidden="true"
        />
        ...
        <div className="container">
          <div className="services-section-header">
            <div className="services-section-header__text">
              <span data-fade className="eyebrow">What We Do</span>
              <div className="divider" />
              <h2 data-fade style={{ transitionDelay: '100ms' }} className="heading-lg">
      ...
      <div className="metrics-strip">
        <div className="container" style={{ padding: 0, maxWidth: '100%' }}>
          <div className="metrics-grid" style={{ maxWidth: 'var(--container-max)', margin: '0 auto', paddingLeft: 'var(--container-padding)', paddingRight: 'var(--container-padding)' }}>
            <div className="metric-item" data-fade style={{ transitionDelay: '0ms' }}>
            ...
            <div className="metric-item" data-fade style={{ transitionDelay: '120ms' }}>
              <span className="metric-value">3</span>
              <span className="metric-label">Core service disciplines under one roof</span>
            </div>
            <div className="metric-item" data-fade style={{ transitionDelay: '240ms' }}>
              <span className="metric-value">12</span>
              <span className="metric-label">Months a year — not just the warm ones</span>
            </div>
            <div className="metric-item" data-fade style={{ transitionDelay: '360ms' }}>
        ...
        <div className="container">
          <div className="about-teaser">
            ...
            <div className="about-teaser__content">
              <span data-fade className="eyebrow">Who We Are</span>
              <div className="divider" />
              <h2 data-fade style={{ transitionDelay: '100ms' }} className="heading-lg">
                Built on three decades of commercial expertise.
              </h2>
              <p data-fade style={{ transitionDelay: '200ms' }} className="body-lg" style={{ marginTop: 'var(--space-5)' }}>
              ...
              <p data-fade style={{ transitionDelay: '300ms' }} className="body-lg" style={{ marginTop: 'var(--space-4)' }}>
              ...
              <div data-fade style={{ transitionDelay: '400ms', display: 'flex', gap: 'var(--space-4)', marginTop: 'var(--space-8)', flexWrap: 'wrap' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <div className="two-col-grid" style={{ alignItems: 'center' }}>
            ...
            <div>
              ...
              <div className="divider" />
              <h2 data-fade style={{ transitionDelay: '100ms', color: 'var(--color-white)' }} className="heading-lg">
                Liquid de-icing.<br />
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-3)' }}>
              <BenefitRow data-fade style={{ transitionDelay: '0ms' }}
                icon={<IconShield />}
              ...
              />
              <BenefitRow data-fade style={{ transitionDelay: '120ms' }}
                icon={<IconClock />}
      ...
      <section className="section section--light">
        <div className="container">
          ...
          <div className="section-header--centered">
            ...
            <div data-fade style={{ transitionDelay: '200ms' }} className="testimonials-header-stat">
            ...
            <div className="form-section-aside">
              <div className="form-aside-card">
                ...
                <div className="form-aside-item">
                  ...
                  <a href={contact.emailHref} className="form-aside-value--accent">
                    {contact.email}
                  </a>
                </div>
  ...
  return (
    <div className="services-grid">
      {services.map((service, i) => (
        <ServiceCard key={service.id} service={service} fadeDelay={i * 120} />
      ))}
    </div>
  )
}
