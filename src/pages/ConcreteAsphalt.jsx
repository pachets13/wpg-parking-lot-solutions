    ...
    <>
      ...
      <section className="section section--white">
        <div className="container">
          <div style={{ maxWidth: 760 }}>
            <span className="eyebrow">Concrete &amp; Asphalt</span>
      ...
      <section style={{ background: 'var(--color-snow)', padding: '0' }}>
        <div style={{ borderRadius: 0, overflow: 'hidden', aspectRatio: '21/9' }}>
          <img
            src="/assets/images/services/concrete-detail.jpg"
      ...
      <section className="section section--light">
        <div className="container">
          <div className="section-header">
            <span className="eyebrow">Why WPG Parking Lot Solutions</span>
            <h2 className="heading-md">Commercial-only focus. Accountability you can count on.</h2>
          </div>
