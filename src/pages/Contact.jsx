              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-6)' }}>
                <div>
                  ...
                  <a href={contact.phoneHref} style={{ fontSize: 'var(--text-xl)', fontWeight: 'var(--font-weight-bold)', color: 'var(--color-white)', textDecoration: 'none', transition: 'color var(--transition-fast)' }}
                    onMouseOver={e => e.target.style.color = 'var(--color-accent-ink)'}
                ...
                <div>
                  ...
                  <a href={contact.emailHref} className="contact-grid__email" style={{ fontSize: 'var(--text-base)', color: 'var(--color-accent-ink)', textDecoration: 'none', display: 'inline-block', maxWidth: '100%' }}>
                    {contact.email}
                  </a>
                </div>
