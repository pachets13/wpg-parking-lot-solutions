      ...
      <section className="section section--white">
        <div className="container">
          <div style={{ maxWidth: 760 }}>
            <span className="eyebrow">Snow &amp; Ice Solutions</span>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--space-16)', alignItems: 'start' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
              {[
                ...
                <div key={item.title} className="feature-item feature-item--dark">
      ...
      <section className="section section--light">
        <div className="container">
          <div className="section-header--centered">
            ...
            <h2 className="heading-md">Before and After</h2>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--space-8)', marginTop: 'var(--space-10)' }}>
            {[
              { label: 'A Typical Winnipeg Winter Parking Lot', file: 'comparison-before.jpg' },
              { label: 'A Winnipeg Winter Parking Lot Maintained by WPG Parking Lot Solutions', file: 'comparison-after.jpg' },
            ].map(item => (
              <div key={item.label}>
                <div style={{
                  aspectRatio: '16/9',
                  ...
                  <img
                    src={`/assets/images/services/${item.file}`}
                    alt={item.label}
      ...
      <section className="section section--white">
        <div className="container">
          <div style={{ borderRadius: 'var(--radius-lg)', overflow: 'hidden', marginBottom: 'var(--space-12)', aspectRatio: '21/9' }}>
            <img
              src="/assets/images/services/equipment-snow.jpg"
              alt="Commercial snow clearing equipment"
              style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }}
            />
          </div>
          <div style={{ maxWidth: 760 }}>
            <span className="eyebrow">Snow Clearing</span>
            <div className="divider" />
            <h2 className="heading-md">Why Choose WPG Parking Lot Solutions for Snow Clearing?</h2>
            <p className="body-lg" style={{ marginTop: 'var(--space-5)' }}>
